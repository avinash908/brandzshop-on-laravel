						...
						<div class="row">
								...
								<div class="row" id="more_details" style="overflow: auto;">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control @error('tags') is-invalid @enderror" style="width: 100%" id="_tags" name="tags[]" multiple required>
							...
							<div class="col-md-12">
								@if($errors->has('description'))
		                            ...
		                            @endforeach
		                        @endif
								<textarea rows="8" name="description" class="form-control summernote @error('description') is-invalid @enderror" required>{{ $product->description }}</textarea>
							</div>
						</div>
