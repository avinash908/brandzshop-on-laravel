(function($) {
    ...
    $(document).ready(function() {
        ...
        // search();
        // filter_brand();
        var list_brand = $('.brand_filters_list li:gt(4)');
        list_brand.hide();
        $('#more_brand_list').click(function() {
            list_brand.slideToggle(400);
            return false;
        });

        var list_cat = $('.cat_filters_list li:gt(4)');
        list_cat.hide();
        $('#more_cat_list').click(function() {
            list_cat.slideToggle(400);
            return false;
        });
